...
function LaundryDetails() {
  ...
  {
    isLoading  ? <p>Loading</p> :  <>   <div className="container grid grid-cols-1 md:grid-cols-6 gap-5 md:gap-10  mx-auto p-4">
    ...
    <div className="col-span-4">
      <div className="bg-white p-4 rounded-lg shadow-md ">
       ...
       <>
       {
        (laundry.reviews.length == 0 ) ? <p>No Reviews...</p> : <><ul>
        {showAllReviews ? (
          laundry.reviews.map((review) => (
            <li key={review.id} className="mb-4 p-4 rounded-lg bg-gray-200">
          ...
          <li className="mb-2 p-4 rounded-lg bg-gray-200">
            ...
            <p className="mt-2">{laundry.reviews[0].description}</p>
          </li>
        )}
      </ul>
