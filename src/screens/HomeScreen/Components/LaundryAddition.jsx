...
const LaundryDialog = () => {
  ...
  return (
   <>
        ...
        <div className="align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all  ">
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <h3 className="text-lg leading-6 font-medium text-gray-900">Add Laundry</h3>
            <form onSubmit={handleSubmit}>
              <div className="mt-4">
                <label className="block text-gray-700 text-sm font-bold">User Name: </label>
                <input className='w-full border border-gray-500 rounded-md py-1 px-2 my-1' placeholder='User Name'/>
                <label className="block text-gray-700 text-sm font-bold">Email: </label>
                <input className='w-full border border-gray-500 rounded-md py-1 px-2 my-1' placeholder='Email Address'/>
